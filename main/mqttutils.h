...
extern mqtt_settings settings;
    ...
    //xEventGroupWaitBits(wifi_event_group, MQTT_PUBLISHED_BIT, true, true, portMAX_DELAY);
    //xEventGroupWaitBits(wifi_event_group, MQTT_INITIATE_PUBLISH_BIT, true, true, portMAX_DELAY);
